...
describe('Block Registrar', function () {
    it('register all blocks in the blocks directory', function () {
    ...
    it('throws an exception when the blocks directory is empty', function () {
        expect(function () {
            BlockRegistrar::new('');
